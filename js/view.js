...
function drawScoreboard() {
	...
	if (gameState === 0) {
		...
		// 渲染AI智能演示按钮
		renderText(trueCanvas.width / 2 + gdx + 5 * settings.scale, h + 70, fontSize, "rgb(231, 76, 60)", 'AI智能演示');
		...
		// 渲染AI智能演示按钮
		renderText(trueCanvas.width / 2 + gdx + 5 * settings.scale, h + 60, fontSize, "rgb(231, 76, 60)", 'AI智能演示');
